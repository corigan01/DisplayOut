...
static bool __IsDisplaying = false;
static std::vector<std::string> AllLog;
...
namespace D_COLOR {
    ...
    static ColorM::Modifier redM(ColorM::FG_RED);
    static ColorM::Modifier greenM(ColorM::FG_GREEN);
    static ColorM::Modifier blueM(ColorM::FG_BLUE);
    static ColorM::Modifier magentaM(ColorM::FG_MAGENTA);
    static ColorM::Modifier yellowM(ColorM::FG_YELLOW);
    static ColorM::Modifier defM(ColorM::FG_DEFAULT);

    static std::string debugstring[] = { "NULL", "LOG", "FILE", "DEBUG", "ERROR", "INFO", "WARNING" };     // Convert the Color to a readable displayname
